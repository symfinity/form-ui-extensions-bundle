# Contributing to Form UI Extensions Bundle

> **Read-only mirror.** This repository (`symfinity/form-ui-extensions-bundle`) is published from the Symfinity product monorepo (`packages/form-ui-extensions-bundle/`). **Do not expect pull requests to be merged here.**

## Report bugs or request features

Open an [issue](https://github.com/symfinity/form-ui-extensions-bundle/issues) on this repository.
...
Open a pull request on the **product monorepo** (`packages/form-ui-extensions-bundle/`) on a `feature/{spec-id}-{slug}` branch. Do not rely on merging on this mirror.
